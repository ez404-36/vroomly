...
class TestUserVehicleDetailSchema:
    """Tests for UserVehicleDetailSchema."""

    def test_create_detail_schema(self):
        """Should create detail schema with all fields."""
        schema = UserVehicleDetailSchema(
    ...
    def test_create_detail_schema_minimal(self):
        """Should create detail schema with minimal fields."""
        schema = UserVehicleDetailSchema(
            id='123e4567-e89b-12d3-a456-426614174000',
            user_id='123e4567-e89b-12d3-a456-426614174001',
        )
        assert schema.vehicle_id is None
