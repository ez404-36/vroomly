...
class TestLiteralCollectorGeneration:
	...
	def test_generate_literal_code_strings(self):
		...
		literal_info = {'name': 'Status', 'values': ["'active'", "'inactive'"], 'file': 'test.py'}
	...
	def test_generate_literal_code_single_value(self):
		...
		literal_info = {'name': 'Single', 'values': ["'only'"], 'file': 'test.py'}
	...
	def test_generate_literal_code_booleans_converted(self):
		...
		literal_info = {'name': 'Flags', 'values': ['true', 'false'], 'file': 'test.py'}
	...
	def test_generate_literal_code_none_converted(self):
		...
		literal_info = {'name': 'Maybe', 'values': ["'value'", 'null'], 'file': 'test.py'}
	...
	def test_generate_literal_code_integers(self):
		...
		literal_info = {'name': 'Numbers', 'values': ['1', '2', '3'], 'file': 'test.py'}
...
""")
		...
		monkeypatch.setattr('scripts.collect_models.FRONTEND_DIR', tmp_path / 'frontend')
