...
class TestCollectModelsAndEnums:
	...
	def test_collect_pydantic_models(self):
		...
		# Динамически созданные классы — PascalCase обязателен по соглашению.
		TestModel1 = type('TestModel1', (BaseModel,), {'__annotations__': {'name': str}})  # noqa: N806
		TestModel2 = type('TestModel2', (BaseModel,), {'__annotations__': {'value': int}})  # noqa: N806

		# Use SimpleNamespace to create a mock module
		fake_module = SimpleNamespace(__name__='test_module', TestModel1=TestModel1, TestModel2=TestModel2)
	...
	def test_collect_enums(self):
		...
		fake_module = SimpleNamespace(__name__='test_module', TestColor=TestColor)
