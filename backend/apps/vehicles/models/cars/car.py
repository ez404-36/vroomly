...
from apps.vehicles.models.cars.car_generation_configuration import (
    CarGenerationConfiguration,
)
...
class Car(
    ...
    configuration_id: Mapped[UUID4] = mapped_column(
        ForeignKeyTo(CarGenerationConfiguration)
    )
    steering_wheel_position: Mapped[SteeringWheelPositionType] = mapped_column(
        IntEnumType(SteeringWheelPositionType)
    )
