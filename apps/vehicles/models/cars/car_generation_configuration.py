...
class CarGenerationConfiguration(
    ...
    transmission: Mapped[CarTransmissionType] = mapped_column(IntEnumType(CarTransmissionType))
    ...
    wheel_drive: Mapped[CarWheelDriveType] = mapped_column(IntEnumType(CarWheelDriveType))
